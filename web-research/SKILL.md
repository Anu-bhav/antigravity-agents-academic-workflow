...
- **Navigate complex websites** (financial news, interactive data) using the browser
...
- **fetch_url**: Fetch content from URLs and convert to markdown
- **task**: Spawn research subagents with web_search access
- **browser_subagent**: Use for deep navigation or when simple fetch fails (e.g. JS-heavy financial sites)
- **notebooklm**: Use for analyzing long PDF reports or querying complex documentation
