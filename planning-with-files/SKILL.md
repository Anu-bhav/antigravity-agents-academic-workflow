...
hooks:
  ...
  Stop:
    - hooks:
        - type: command
          command: "python3 ${CLAUDE_PLUGIN_ROOT}/scripts/check_complete.py"
---
...
- `scripts/init_session.py` — Initialize all planning files
- `scripts/check_complete.py` — Verify all phases complete
...
- **All Skills**: This skill creates the roadmap for using any other skill.
- **academic-standards**: Plan should include standards verification steps.

## Next Steps

- **Execute**: Start the first phase in your `task_plan.md`.
- **Verify**: Run `python scripts/check_complete.py` to check progress.
